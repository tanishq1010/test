...
def for_all_exam_goal(goal_exam_grade):
    for ind in goal_exam_grade.index:
     # if goal_exam_grade["Exam_name"][ind]=="JEE Main":
...
if __name__ == '__main__':
    ...
    df1.to_csv('positive_test_results_all_subjects.csv', na_rep='NA',index=False)
    df2=pd.read_csv('positive_test_results.csv')
    df2.to_csv('positive_test_results.csv',index=False,na_rep='NA')

    df3=pd.read_csv('negative_test_results_all_subjects.csv')
    df3.to_csv('negative_test_results_all_subjects.csv',index=False,na_rep='NA')

    df4=pd.read_csv('negative_test_results.csv')
    df4.to_csv('negative_test_results.csv',index=False,na_rep='NA')
